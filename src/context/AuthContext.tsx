...
import { validateIDLCLogin } from "@/lib/data/demo-users";
...
export function AuthProvider({ children }: { children: React.ReactNode }) {
  ...
  const login = useCallback(async (email: string, password: string) => {
    ...
    // Helpful error for malformed IDLC credentials
    ...
    return { success: false, error: "Invalid credentials. Use your @idlc.com email and 6-digit Employee CIF." };
  }, []);
